	...
	*/
	...
	v("Promise", function(a) {
		...
		b.prototype.I =
			function() {
				...
				"function" === typeof c ? c = new c("unhandledrejection", {
					...
					cancelable: !0
				}) : (c = u.document.createEvent("CustomEvent"), c.initCustomEvent("unhandledrejection",
					!1, !0, c));
				c.promise = this;
				c.reason = this.i;
				return g(c)
		...
		b.all = function(c) {
			...
			return g.done ? f([]) : new b(function(k, m) {
				...
				var p = [],
					r = 0;
				do p.push(void 0), r++, f(g.value).s(G(p.length - 1), m), g = d.next(); while (!
					g.done)
			})
		};
		return b
	...
	N.prototype.start = function() {
		...
		return J(new I(new B(function(e) {
			navigator.mediaDevices && navigator.mediaDevices.getUserMedia || alert(
	...
	for (var T; R.length && (T = R.shift());) R.length || void 0 === N ? S[T] && S[T] !== Object.prototype[T] ? S =
		S[T] : S = S[T] = {} : S[T] = N;
}).call(this);